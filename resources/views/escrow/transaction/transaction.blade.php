		...
		<div class="content">
			<div class="billing-details">
				<div class="billing-details-content">
					<div class="bil-title">Billing Details</div>
					 <table>
					 	<tr>
					 		<td><i class="material-icons">spa</i> Round Bowl</td>
					 		
					 		<td class="right-t">$2100</td>
					 	</tr>
					 	<tr>
					 		<td><i class="material-icons">local_shipping</i> Shipping fee</td>
					 		<td class="right-t">$50</td>
					 	</tr>
					 	<tr>
					 		<td><i class="material-icons">money</i> Tax</td>
					 		<td class="right-t">$20</td>
					 	</tr>
					 	<tr class="br-top">
					 		<td>Amount Payable</td>
					 		<td class="right-t">$2170</td>
					 	</tr>
					 </table>
				</div>
			</div>
            <div class="list-content">
                <div class="list-content-item d-flex-row">
                    <div class="list-icon d-flex"><i class="material-icons">folder</i></div>
                    <div class="list-name d-flex flex-1">Construction bank</div>
